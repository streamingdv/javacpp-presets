...
@Properties(
    ...
    value = {
        ...
        // No libatomic preload on macOS: the libraries do not need it, and copying it out of the
        // runner's Homebrew GCC pulls in a dylib built for the runner's macOS version.
